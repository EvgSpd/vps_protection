...
Основана на механизмах защиты из проекта [AntiZapret-VPN](https://github.com/GubernievS/AntiZapret-VPN). (вырезана из его кода с помощью llm).

Сделано исключительно для удобства пользователей и развития экосистемы.
